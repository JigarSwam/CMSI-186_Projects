...
public class CalendarStuffTester {
   ...
   */
   static void test_daysBetween() {
     ...
     System.out.print( "   Counting 1461 days  between 01-02-2000 and 01-02-2004 : " );
     try { System.out.println(    1461 == CalendarStuff.daysBetween(  1, 2, 2000,  1, 2, 2004 ) ? "1461 days   " : "bad count" ); }
     catch( Exception e ) { System.out.println( false ); }

     System.out.print( "   Counting 1391 days  between 03-12-2000 and 01-02-2004 : " );
     try { System.out.println(    1391 == CalendarStuff.daysBetween(  3, 12, 2000,  1, 2, 2004 ) ? "1391 days   " : "bad count" ); }
     catch( Exception e ) { System.out.println( false ); }
   }
